...
- **Python Development** — Pandas, NumPy, SciPy, scikit‑learn, Matplotlib, Seaborn, Altair, JSON handling, scheduling libraries  
- **Machine Learning & Modeling** — Scaling (MinMaxScaler), optimization (root_scalar), randomization, statistical modeling  
